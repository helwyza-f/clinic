...
const DashboardCalendarView = dynamic(
  () => import("./dashboard_calendar_view"),
  {
    ssr: false,
    loading: () => (
      <div className="h-[360px] w-full flex flex-col items-center justify-center bg-white rounded-[2rem] border border-dashed border-slate-100 gap-4">
...
export default function AdminDashboard() {
  ...
  return (
    <div className="space-y-5 pb-10 animate-in fade-in duration-700 px-1">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-3 px-1">
        ...
        <div className="bg-white px-3.5 py-2 rounded-xl border border-slate-100 flex items-center gap-2.5 shadow-sm ring-1 ring-slate-50">
            ...
            <CardContent className="p-0">
              ...
              >
                <div className="flex justify-between items-start">
                  <div className="space-y-1">
                    <p className="text-[8px] font-black uppercase tracking-[0.25em] opacity-80">
                      {item.title}
                    </p>
      ...
      <Card className="border-none shadow-lg bg-white rounded-[1.5rem] overflow-hidden border border-slate-100">
        <CardHeader className="bg-gradient-to-r from-[#959cc9] to-[#d9c3b6] p-4 text-white flex flex-row items-center justify-between border-b border-white/10">
          <div className="flex items-center gap-3">
            <div className="p-2 bg-black/10 backdrop-blur-md rounded-lg border border-white/20 shadow-lg">
              <CalendarDays className="w-5 h-5 text-white" />
            </div>
            <div>
              <CardTitle className="text-base font-black uppercase tracking-[0.15em] leading-none text-white">
                Visualisasi Beban Kerja
              </CardTitle>
              <p className="text-[8px] font-bold text-white/70 uppercase tracking-[0.3em] mt-1">
                Arsip Antrean Bulanan
              </p>
            </div>
          </div>
          <Badge className="bg-white/20 text-white border-white/20 font-black uppercase text-[8px] tracking-widest px-2.5 py-1 rounded-full backdrop-blur-sm shadow-inner">
            Real-time Feed
          </Badge>
        </CardHeader>
