  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full bg-white">
      <div className="p-8 border-b border-slate-50">
        ...
        <p className="text-[10px] text-[#959cc9] font-black text-center uppercase tracking-[0.4em] mt-1.5 opacity-80">
          Medical Area
        </p>
      </div>
  ...
  return (
    <div className="flex min-h-screen bg-[#fafafa]">
      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <div className="p-6 lg:p-10 overflow-y-auto max-w-[1600px] mx-auto w-full animate-in fade-in slide-in-from-bottom-2 duration-700">
          {children}
        </div>
      </main>
    </div>
